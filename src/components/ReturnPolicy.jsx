...
const returnPolicy = [
  {
    ...
    icon: <Undo2 className="w-6 h-6 text-indigo-500" />,
    content: `
      Refunds are only applicable under the following conditions:
      1. If <b>Magic Scale Restaurant Consultant</b> is unable to deliver the agreed service due to internal issues or unforeseen circumstances.
  ...
  },
  {
    ...
    content: `
      For any questions or concerns about our Return and Refund Policy, reach out to us:
    `,
    details: [
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6">
              Return & <span className="text-indigo-600 dark:text-indigo-400">Refund</span>
            </h1>
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl">
              Our policy on returns, refunds, and cancellations is designed to be fair and transparent for all our clients.
            </p>
          </motion.div>
        </div>
      </section>
