...
const SellerDashboard = () => {
  ...
  const getDownloadUrl = (filePath) => {
    if (!filePath) return "#"; // Safety check for missing files
          ...
          <div className="max-w-6xl mx-auto mb-10 text-center">
            <div className="inline-flex flex-wrap justify-center bg-white dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none gap-1 md:gap-2">
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'customers'
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'transactions'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'enquiries'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'applications'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'jobs'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'blogs'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'gallery'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-5 py-2.5 rounded-xl text-[11px] md:text-sm font-bold transition-all ${activeTab === 'paylinks'
                    ? 'bg-red-500 text-white shadow-lg shadow-red-200 dark:shadow-none'
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                  }`}
              >
