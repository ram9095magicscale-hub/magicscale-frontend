            ...
            <div className="space-y-16 lg:space-y-20">
              ...
              <div className="pt-10 border-t border-slate-200/80 dark:border-slate-800/80">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                  ...
                  <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500/0 via-orange-500/20 to-orange-500/0 z-0" />
                  ...
                  {[
                    ...
                    },
                    {
                      step: "02",
                      title: "Execution",
                      desc: "Our experts handle all documentation and menu setup on Swiggy.",
                    ...
                    <div key={idx} className={`relative z-10 p-8 rounded-[2rem] border transition-all duration-500 group overflow-hidden ${
                      isDarkMode 
                        ? 'bg-[#0f172a]/40 border-slate-800 hover:border-orange-500/30' 
                        : 'bg-white border-slate-100 shadow-sm hover:shadow-xl hover:border-orange-100'
                    }`}>
                      ...
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-transform duration-500 group-hover:scale-110 ${
                        isDarkMode ? 'bg-slate-800/80 border border-slate-700' : 'bg-orange-50 border border-orange-100'
                      }`}>
                        {item.icon}
                      </div>
